...
class Testdatabase_obj:
    ...
    def test_insert_update(self):
        ...
        assert self.data.insert_update('INSERT INTO test_tb_0 (title, gender, description, phone, statue)',[('test23', '1', 'test_insert_update', '87123212', '1')]) == 1
    ...
    def test_execute_select(self):
        ...
        assert (description, id, 'test_execute_select') in  self.data.execute_select('SELECT test_tb_0.description test_tb_1.second_id, test_tb_1.title, FROM test_tb_0 INNER JOIN test_tb_1 ON test_tb_0.id = test_tb_1.id')
